...
def parser_train():
    ...
    parser.add_argument('--data-dir', type=str, default='../Adversarial-Robustness-Limits/mnt/MLdata/CIFAR-10-EDM/')
    parser.add_argument('--log-dir', type=str, default='../Adversarial-Robustness-Limits/mnt/MLdata/log/')
    ...
    parser.add_argument('--beta', default=5.0, type=float, help='Stability regularization, i.e., 1/lambda in TRADES.')
    ...
    parser.add_argument('--aux-data-filename', type=str, help='Path to additional Tiny Images data.', 
                        default='../Adversarial-Robustness-Limits/mnt/MLdata/CIFAR-10-EDM/1m.npz')

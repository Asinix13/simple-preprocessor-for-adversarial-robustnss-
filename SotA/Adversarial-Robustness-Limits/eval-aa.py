...
# AA Evaluation
eps = 8./255. if (args.norm == 'Linf') else 0.5

seed(args.seed)
adversary = AutoAttack(model, norm=args.norm, eps=eps, log_path=log_path, version=args.version, seed=args.seed) 

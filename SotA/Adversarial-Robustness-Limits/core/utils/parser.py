...
def parser_train(parser):
    ...
    parser.add_argument('--data-dir', type=str, default='./mnt/MLdata/CIFAR-10-EDM')
    parser.add_argument('--log-dir', type=str, default='./mnt/MLdata/log')
    ...
    parser.add_argument('--beta', default=5, type=float, help='Stability regularization, i.e., 1/lambda in TRADES.')
    ...
    parser.add_argument('--aux-data-filename', type=str, help='Path to additional Tiny Images data.',
                        default='./mnt/MLdata/CIFAR-10-EDM/1m.npz')

    parser.add_argument('--seed', type=int, default=1, help='Random seed.')

    ### Filter
    parser.add_argument('--filter',  action='store_true', default=False, help='if a filter is used')
    parser.add_argument('--bil', type=int, default=10, help='Bilateral filter amount')
    parser.add_argument('--gvar', type=float, default=0.032, help='Gaussian noise variance')
...
def parser_eval():
    ...
    parser.add_argument('-v', '--version', type=str, default='standard', choices=['custom', 'plus', 'standard', 'rand'],
                        help='Version of AA.')
    parser.add_argument('--weights', default='weights-best.pt', help='Which weights to use')
    parser.add_argument('--norm', default='Linf', help='Which AA norm to use')

    # mult-adv.py
    parser.add_argument('--TABPDA', action='store_true', default=False, help='Evaluate with TABPDA')

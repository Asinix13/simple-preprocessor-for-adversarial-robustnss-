    ...
    def __init__(self, base_dataset='cifar10', take_amount=None, take_amount_seed=13, aux_data_filename=None, 
        ...
        if self.train:
            ...
            if aux_data_filename[0] == '!':
                ...
                path_dict = {
                    'pfgmpp18': ['./mnt/MLdata/virtual/pfgmpp/18-steps/first-batch-50mil-pfgmpp-EDM-cifar10-18-steps.h5',
                                 './mnt/MLdata/virtual/pfgmpp/18-steps/second-batch-50mil-pfgmpp-EDM-cifar10-18-steps.h5'] ,
                    'dg20': ['./mnt/MLdata/virtual/discriminator-guidance/20-steps/first-batch-50mil-dg-EDM-cifar10-20-steps.h5',
                             './mnt/MLdata/virtual/discriminator-guidance/20-steps/second-batch-50mil-dg-EDM-cifar10-20-steps.h5'] ,
                    'vanilla20': ['./mnt/MLdata/virtual/edm50_shuffled.h5',
                                  './mnt/MLdata/virtual/vanilla/20-steps/first-batch-vanilla-edm-50mil-20-steps.h5'], 
            
                    'vanilla20dg20pfgmpp18': ['./mnt/MLdata/virtual/edm50_shuffled.h5',
                           './mnt/MLdata/virtual/discriminator-guidance/20-steps/first-batch-50mil-dg-EDM-cifar10-20-steps.h5',
                           './mnt/MLdata/virtual/pfgmpp/18-steps/first-batch-50mil-pfgmpp-EDM-cifar10-18-steps.h5',
                           './mnt/MLdata/virtual/vanilla/20-steps/first-batch-vanilla-edm-50mil-20-steps.h5',
                           './mnt/MLdata/virtual/discriminator-guidance/20-steps/second-batch-50mil-dg-EDM-cifar10-20-steps.h5',
                           './mnt/MLdata/virtual/pfgmpp/18-steps/second-batch-50mil-pfgmpp-EDM-cifar10-18-steps.h5'],

                    'vanilla20dg20pfgmpp18-150': ['./mnt/MLdata/virtual/edm50_shuffled.h5',
                           './mnt/MLdata/virtual/discriminator-guidance/20-steps/first-batch-50mil-dg-EDM-cifar10-20-steps.h5',
                           './mnt/MLdata/virtual/pfgmpp/18-steps/first-batch-50mil-pfgmpp-EDM-cifar10-18-steps.h5'],

                    'vanilla10': ['./mnt/MLdata/virtual/vanilla/10-steps/first-batch-vanilla-edm-30mil-10-steps.h5'],
                    'vanilla5': ['./mnt/MLdata/virtual/vanilla/5-steps/first-batch-vanilla-edm-30mil-5-steps.h5'],
                    'vanilla6': ['./mnt/MLdata/virtual/vanilla/6-steps/first-batch-vanilla-edm-30mil-6-steps.h5'],
                    'vanilla7': ['./mnt/MLdata/virtual/vanilla/7-steps/first-batch-vanilla-edm-30mil-7-steps.h5',
                                 './mnt/MLdata/virtual/vanilla/7-steps/second-batch-vanilla-edm-40mil-7-steps.h5',
                                 './mnt/MLdata/virtual/vanilla/7-steps/third-batch-vanilla-edm-30mil-7-steps.h5',
                                ]
                    } 
            ...
            if aux_data_filename is not None:
                ...
                if os.path.splitext(aux_path)[1] == '.pickle':
                    ...
                    if aux_path != './mnt/MLdata/CIFAR-10-EDM/discriminator-guidance/5m.npz':
                ...
                if aux_count < 50e6 and not virtual_file_path_list:
                    ...
                    path_to_virtual_data = "./mnt/MLdata/virtual/VDS.h5"
                    if virtual_file_path_list:
                        millions = int(aux_count/1e6) 
                        path_to_virtual_data = f"./mnt/MLdata/virtual/{aux_data_kind}_{millions}M_VDS.h5"
                    ...
                    if env is not None:
                        dist.barrier()
                    aux_targets = h5py.File('./mnt/MLdata/virtual/edm50_shuffled.h5', 'r')['label'][:].astype(int)
                    if virtual_file_path_list:
                        aux_targets = []
...
def make_virtual_dataset(path, self_data, orig_len, aux_count, virtual_file_path_list = None):
    ...
    if './mnt/MLdata/virtual/vanilla/7-steps/third-batch-vanilla-edm-30mil-7-steps.h5' in virtual_file_path_list:
        file_lengths = {i:int(x) for i,x in zip(range(1,4), [30e6,40e6,30e6])}
    file_lengths[0] = orig_len
    print(virtual_file_path_list, path)
    ...
    name1 = './mnt/MLdata/virtual/c10.h5'
    directory = os.path.dirname(name1)
    ...
    if not virtual_file_path_list:
        ...
        name2 = './mnt/MLdata/virtual/edm50_shuffled.h5'  

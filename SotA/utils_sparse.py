...
def AutoAttack_Wrapper(model, device, X, y, args, logger, sub_dir_path, start_batch, end_batch, checkpoint_path = None, distance="linf", epsilon=8/255, attack_type=None, batch_size = 8, workers=4, rand = False, **kwargs):
    """
    ...
    adversary = AutoAttack(model, norm="Linf" if distance=="linf" else "L2", version= version, eps=epsilon)
    if attack_type != None:
